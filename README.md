...
Memfile is an in-memory, thread-safe, dependency-free file abstraction. It seeks to be compatible with most of the `io` interfaces that `os.File` supports, so I can be used as a drop-in replacement.
