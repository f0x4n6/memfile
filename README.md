...
Memfile is an in-memory thread-safe file abstraction for Go. It seeks to be compatible with most of the `io` interfaces that `os.File` supports, so I can be used as an drop-in replacement.
